            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
					...
					<?php if ($layout_module['position'] == 'baner') { ?>
                    <option value="baner" selected="selected">Baner</option>
                    <?php } else { ?>
                    <option value="baner">Baner</option>
					<?php } ?>
					
					<?php if ($layout_module['position'] == 'baner_1') { ?>
                    <option value="baner_1" selected="selected">Baner 1</option>
                    <?php } else { ?>
                    <option value="baner_1">Baner 1</option>
                    <?php } ?>
					
					<?php if ($layout_module['position'] == 'baner_2') { ?>
                    <option value="baner_2" selected="selected">Baner 2</option>
                    <?php } else { ?>
                    <option value="baner_2">Baner 2</option>
                    <?php } ?>
					
					<?php if ($layout_module['position'] == 'baner_3') { ?>
                    <option value="baner_3" selected="selected">Baner 3</option>
                    <?php } else { ?>
                    <option value="baner_3">Baner 3</option>
                    <?php } ?>
...
function addModule() {
	...
	html += '    <option value="baner">Baner</option>';
	html += '    <option value="baner_1">Baner 1</option>';
	html += '    <option value="baner_2">Baner 2</option>';
	html += '    <option value="baner_3">Baner 3</option>';
    html += '  </select></td>';
